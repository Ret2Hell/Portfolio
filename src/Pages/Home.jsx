...
const TECH_STACK = ["Typescript", "React", "Next js", "Tailwind", "Nestjs"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Ret2Hell" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/mohamed-yassine-taieb-2016552a0/",
  },
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://taieb-mohamed-yassine.vercel.app/NLbpVqGegK.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  I&apos;m a full-stack web developer interested in making
                  dynamic digital experiences and learning how AI can be applied
                  to enhance the interaction and functionality of users.
                </p>
